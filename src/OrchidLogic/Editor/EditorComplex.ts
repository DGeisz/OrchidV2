...
/**
 * The EditorComplex is basically the highest level container
 * for everything going on in the editor for a given project.
 *
 * The EditorComplex tries to do as little as possible, and simply
 * provides connections and communication between its constituents
 */
export class EditorComplex {
    private readonly controller: Controller;
    private readonly dock: Dock;
    private readonly projectPages: Page[];
    ...
    constructor() {
        ...
        this.projectPages = [];
        this.projectPages.push(this.currentPage);

        this.dock = new Dock(this);
        this.controller = new Controller(this.dock);
    }
